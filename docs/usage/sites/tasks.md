...
While not included as a core component, the module is one of the externally-maintained ones that ships with Aegir.  These modules are referred to as [Golden Contrib](http://cgit.drupalcode.org/hostmaster/tree/drupal-org.make).
