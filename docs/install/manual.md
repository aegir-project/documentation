...
For troubleshooting this process and resulting install, see the `common installation problems page`_.

You may also want to read on with `what you can do with Aegir`_ now that it is installed.
